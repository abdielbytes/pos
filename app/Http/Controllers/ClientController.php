...
class ClientController extends BaseController
{
    ...
    public function index(request $request)
    {
        ...
        foreach ($clients as $client) {
            ...
            $item['Guarantor1_name']= $client->Guarantor1_name;
            $item['Guarantor2_name']= $client->Guarantor2_name;
            $item['Guarantor2_house']= $client->Guarantor2_house;
            $item['Guarantor1_house']= $client->Guarantor1_house;
            $item['Guarantor1_phone']= $client->Guarantor1_phone;
            $item['Guarantor2_phone']= $client->Guarantor2_phone;
            $item['google_map_address'] = $client->google_map_address;
            $item['tracker_id']= $client->tracker_id;
            $item['tracker_model']= $client->tracker_model;

            $item['customeravatar'] = $client->customeravatar;
            $item['g1avatar'] = $client->g1avatar;
            $item['g2avatar'] = $client->g2avatar;
...
//------------- STORE NEW CUSTOMER -------------\\
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'gurantorfullnameg1' => 'nullable|string|max:255',
            'gurantorphoneg1' => 'nullable|string|max:20',
            'gurantorgoogle_address_g1' => 'nullable|string|max:255',
            'gurantorfullnameg2' => 'nullable|string|max:255',
            'gurantorphoneg2' => 'nullable|string|max:20',
            'gurantorgoogle_address_g2' => 'nullable|string|max:255',
            'googleadresse' => 'nullable|string|max:255',
            'tracker_model' => 'nullable|string|max:255',
            'tracker_id' => 'nullable|string|max:255',
            'customeravatar' => 'nullable|image',
            'g1avatar' => 'nullable|image',
            'g2avatar' => 'nullable|image',
        ]);

        \DB::transaction(function () use ($request) {
            $customerAvatar = $this->handleImageUpload($request, 'customeravatar', 'no_avatar.png');
            $g1avatar = $this->handleImageUpload($request, 'g1avatar', 'no_avatar.png');
            $g2avatar = $this->handleImageUpload($request, 'g2avatar', 'no_avatar.png');
            ...
            $client->Guarantor1_name = $request['gurantorfullnameg1'];
            $client->Guarantor1_phone = $request['gurantorphoneg1'];
            $client->Guarantor1_house = $request['gurantorgoogle_address_g1'];
            $client->Guarantor2_name = $request['gurantorfullnameg2'];
            $client->Guarantor2_phone = $request['gurantorphoneg2'];
            $client->Guarantor2_house = $request['gurantorgoogle_address_g2'];
            $client->customeravatar = $customerAvatar;
            $client->g1avatar = $g1avatar;
            $client->g2avatar = $g2avatar;
            $client->tracker_model = $request['tracker_model'];
            $client->tracker_id = $request['tracker_id'];
            $client->google_map_address = $request['googleadresse'];
