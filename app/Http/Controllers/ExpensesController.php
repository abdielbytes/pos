...
class ExpensesController extends BaseController
{
    ...
    public function index(request $request)
    {
        ...
        $columns = array(0 => 'Ref', 1 => 'branch_id', 2 => 'date', 3 => 'expense_category_id');
        $param = array(0 => 'like', 1 => '=', 2 => '=', 3 => '=');
        $data = array();

        // Check If User Has Permission View  All Records
        $Expenses = Expense::with('expense_category', 'branch')
...
//            'expense.category_id' => 'required',
        ...
        Expense::create([
            ...
            'branch_id' => $request['expense']['branch_id'],
//            'expense_category_id' => $request['expense']['category_id'],
    ...
    public function edit(Request $request, $id)
    {
        ...
        if ($Expense->branch_id) {
            if (branch::where('id', $Expense->branch_id)
                ->where('deleted_at', '=', null)
                ->first()) {
