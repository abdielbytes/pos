...
class CreateSalesTable extends Migration {
	...
	public function up()
	{
		Schema::create('sales', function(Blueprint $table)
		{
			...
			$table->integer('branch_id')->index('branch_id_sale');
            ...
            $table->float('penalty')->nullable()->default(0);
            $table->float('installment')->nullable()->default(30000);
            $table->string('payment_frequency')->nullable()->default('Daily');
