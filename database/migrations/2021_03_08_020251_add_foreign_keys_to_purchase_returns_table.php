...
class AddForeignKeysToPurchaseReturnsTable extends Migration {
	...
	public function up()
	{
		Schema::table('purchase_returns', function(Blueprint $table)
		{
			...
			$table->foreign('branch_id', 'purchase_return_branch_id')->references('id')->on('branches')->onUpdate('RESTRICT')->onDelete('RESTRICT');
		});
	}
	...
	public function down()
	{
		Schema::table('purchase_returns', function(Blueprint $table)
		{
			...
			$table->dropForeign('purchase_return_branch_id');
		});
	}
