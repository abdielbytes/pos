...
class AddForeignKeysToSaleReturnsTable extends Migration {
	...
	public function up()
	{
		Schema::table('sale_returns', function(Blueprint $table)
		{
			...
			$table->foreign('branch_id', 'branch_id_sale_return_id')->references('id')->on('branches')->onUpdate('RESTRICT')->onDelete('RESTRICT');
		});
	}
	...
	public function down()
	{
		Schema::table('sale_returns', function(Blueprint $table)
		{
			...
			$table->dropForeign('branch_id_sale_return_id');
		});
	}
