        ...
        <ul class="navigation-left">
          ...
          <li
            v-show="currentUserPermissions && (currentUserPermissions.includes('setting_system')
                        ...
                        || currentUserPermissions.includes('branch')
          ...
          <li
            v-show="currentUserPermissions &&
                     ...
                     || currentUserPermissions.includes('branch_report')
...
<!--          </li>-->
          ...
          >
            <router-link tag="a" class to="/app/People/Users">
              <i class="nav-icon i-Administrator"></i>
              <span class="item-name">{{$t('Staffs')}}</span>
            </router-link>
          </li>
        </ul>
...
<!--          </li>-->
          ...
          <li
            class="nav-item"
            v-if="currentUserPermissions && currentUserPermissions.includes('branch')"
          >
            <router-link tag="a" class to="/app/settings/branches">
              <i class="nav-icon i-Clothing-Store"></i>
              <span class="item-name">{{$t('Branches')}}</span>
            </router-link>
          </li>
          <li
            class="nav-item"
...
<!--              </li>-->
          ...
          <li
            class="nav-item"
            v-if="currentUserPermissions && currentUserPermissions.includes('branch_report')"
          >
            <router-link tag="a" class to="/app/reports/branch_report">
              <i class="nav-icon i-Pie-Chart"></i>
              <span class="item-name">{{$t('branch_report')}}</span>
            </router-link>
          </li>
          <li
            class="nav-item"
