...
export default {
    ...
    Defaultbranch:'المستودع الافتراضي',
    ...
    Enter_Name_branch: 'أدخل اسم المستودع',
    Enter_Phone_branch: 'أدخل هاتف المستودع',
    Enter_Country_branch: 'أدخل بلد المستودع',
    Enter_City_branch: 'أدخل مدينة المستودع',
    Enter_Email_branch: 'أدخل البريد الإلكتروني للمستودع',
    Enter_ZipCode_branch: 'أدخل الرمز البريدي للمستودع',
    ...
    branch_report: 'تقرير المستودع',
    All_branches: 'جميع المستودعات',
    ...
    branchIdentical: 'لا يمكن أن يكون المستودعين متطابقين',
    ...
    branchestockChart: 'الرسم البياني لسهم المستودع',
    ...
    Selectbranch: 'الرجاء اختيار المستودع',
    ...
    Frombranch: 'من المستودع',
    Tobranch: 'إلى المستودع',
    ...
    Delete: {
        ...
        branchDeleted: 'تم حذف هذا المخزن  بنجاح',
    ...
    branchestockChart: 'مخطط المخزون  المستودعات',
    ...
    Name: 'اسم',
    Code: 'الكود',
    Managementbranch: 'إدارة المستودعات',
    ...
    PleaseSelectbranch: 'يرجى تحديد المستودع قبل اختيار أي منتج',
    ...
    ReturnDashboard: 'العودة إلى لوحة القيادة',
     ...
     Assigned_branches:'المخازن المخصصة',
    ...
    Qty_purchased:'الكمية المشتراة',
    Filter_by_branch:'تصفية بالمستودع',
    Enable_Print_Invoice:'قم بتمكين طباعة الفاتورة تلقائيًا',
    Show_branch:'عرض المستودع',
    credit_card_info:'معلومات بطاقة الائتمان',
