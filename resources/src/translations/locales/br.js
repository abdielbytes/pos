...
export default {
    ...
    Choose_branch: 'Escolher Armazém',
    ...
    Enter_Name_branch: 'Enter branch Name',

    Enter_Phone_branch: 'Enter branch Phone',

    Enter_Country_branch: 'Enter branch Country',

    Enter_City_branch: 'Enter branch City',

    Enter_Email_branch: 'Enter branch Email',

    Enter_ZipCode_branch: 'Enter branch Zip Code',
    ...
    branch_report: 'Relatório do armazém',

    All_branches: 'Todos os Armazéns',
    ...
    branchIdentical: 'Os dois armazéns não podem ser idênticos !!',
    ...
    branchestockChart: 'Gráfico de Estoque do Armazém',
    ...
    Selectbranch: 'Selecione o armazém',
    ...
    Frombranch: 'Do armazém',

    Tobranch: 'Para Armazém',
    ...
    Delete: {
        ...
        branchDeleted: 'Este Armazém foi excluído.',
    ...
    Managementbranch: 'Gerenciamento de armazenagem',
    ...
    PleaseSelectbranch: 'Please Select branch before choose any product',
    ...
    Assigned_branches:'Acessar armazéns',
    ...
    Qty_purchased:'quantidade comprada',
    Filter_by_branch:'Filtrar por armazém',
    Enable_Print_Invoice:'Imprimir fatura automaticamente',
    Show_branch:'Mostrar armazém',
    credit_card_info: 'Informações do cartão de crédito',
