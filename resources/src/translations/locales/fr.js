...
export default {
    ...
    Defaultbranch:'Entrepôt par défaut',
    ...
    Choose_branch: 'Choisissez l\'entrepôt',
    ...
    Enter_Name_branch: 'Entrez le nom de l\'entrepôt',
    Enter_Phone_branch: 'Entrez le téléphone de l\'entrepôt',
    Enter_Country_branch: 'Entrez le pays de l\'entrepôt',
    Enter_City_branch: 'Entrez la ville de l\'entrepôt',
    Enter_Email_branch: 'Entrez  e-mail de l\'entrepôt',
    Enter_ZipCode_branch: 'Entrez le code postal de l\'entrepôt',
    ...
    branch_report: 'Rapport d\'entrepôt',
    All_branches: 'Tous les entrepôts',
    ...
    branchIdentical: 'Les deux magasins ne peuvent pas être identiques !!',
    ...
    branchestockChart: 'branch Stock Chart',
    ...
    Selectbranch: 'Sélectionner un entrepôt',
    ...
    PayeBy: 'Payé avec',
    Choosebranch: 'Choisissez l\'entrepôt',
    ...
    Frombranch: 'De l\'entrepôt',
    Tobranch: 'vers l\'entrepôt',
    ...
    Delete: {
        ...
        branchDeleted: 'Ce magasin a été supprimé',
    ...
    branchestockChart: 'Graphique du stock d\'entrepôt',
    ...
    Name: 'Nom',
    Code: 'Code',
    Managementbranch: 'Gestion d\'entrepôt',
    ZipCode: 'Code postal',
    ...
    PleaseSelectbranch: 'Veuillez les sélectionner magasin avant de choisir un produit',
    ...
    ReturnDashboard: 'Retour au tableau de bord',
     ...
     Assigned_branches:'Entrepôts affectés',
    ...
    Some_branches:'Certains entrepôts',
    All_branches:'Tous les entrepôts',
    ...
    Qty_sold:'Qté vendue',
    Qty_purchased:'Qté achetée',
    Filter_by_branch:'Filtrer par magasin',
    Enable_Print_Invoice:'Imprimer la facture automatiquement',
    Show_branch:'voir l\'entrepôt',
