...
export default {
    ...
    Defaultbranch:'Склад по умолчанию',
    ...
    Enter_Name_branch: 'Введите название склада',
    Enter_Phone_branch: 'Введите телефон склада',
    Enter_Country_branch: 'Укажите страну склада',
    Enter_City_branch: 'Введите город склада',
    Enter_Email_branch: 'Введите адрес электронной почты склада',
    Enter_ZipCode_branch: 'Введите почтовый индекс склада',
    ...
    branch_report: 'Отчет о складе',
    All_branches: 'Все склады',
    ...
    branchIdentical: 'Два склада не могут быть идентичными !!',
    ...
    branchestockChart: 'График складских запасов',
    ...
    Selectbranch: 'Пожалуйста, выберите склад',
    ...
    Delete: {
        ...
        branchDeleted: 'Этот склад был удален.',
    ...
    Name: 'название',
    Code: 'Код',
    Managementbranch: 'Управление складом',
    ...
    PleaseSelectbranch: 'Пожалуйста, выберите склад, прежде чем выбрать любой продукт',
    ...
    ReturnDashboard: 'вернуться на панель управления',
     ...
     Assigned_branches:'Присвоенные склады',
    ...
    Some_branches:'Некоторые склады',
    All_branches:'Все склады',
    ...
    Qty_purchased:'Кол-во куплено',
    Filter_by_branch:'Отфильтровать по складу',
    Enable_Print_Invoice:'Распечатать счет автоматически',
    Show_branch:'посмотреть склад',
