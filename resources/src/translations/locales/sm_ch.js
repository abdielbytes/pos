...
export default {
    ...
    Enter_Name_branch: '输入仓库名称',
    Enter_Phone_branch: '输入仓库电话',
    Enter_Country_branch: '输入仓库国家',
    Enter_City_branch: '进入仓库城市',
    Enter_Email_branch: '输入仓库电子邮件',
    Enter_ZipCode_branch: '输入仓库邮政编码',
    ...
    PleaseSelectbranch: '选择任何产品之前，请先选择仓库',
    StockTransfer: '库存转移',
    SelectPeriod: '选择时期',
    ThisYear: '今年',
    ThisToday: '今天',
