...
export default {
    ...
    Enter_Name_branch: '輸入倉庫名稱',
    Enter_Phone_branch: '輸入倉庫電話',
    Enter_Country_branch: '輸入倉庫國家',
    Enter_City_branch: '進入倉庫城市',
    Enter_Email_branch: '輸入倉庫電子郵件',
    Enter_ZipCode_branch: '輸入倉庫郵政編碼',
    ...
    PleaseSelectbranch: '選擇任何產品之前，請先選擇倉庫',
    StockTransfer: '庫存轉移',
    SelectPeriod: '選擇時期',
    ThisYear: '今年',
    ThisToday: '今天',
