...
export default {
    ...
    Enter_Name_branch: 'Depo Adını Girin',
    Enter_Phone_branch: 'Depo Telefonunu Girin',
    Enter_Country_branch: 'Depo Ülkesini Girin',
    Enter_City_branch: 'Depo Şehrini Girin',
    Enter_Email_branch: 'Depo E-postasını Girin',
    Enter_ZipCode_branch: 'Depo Posta Kodunu Girin',
    ...
    branch_report: 'Depo raporu',
    All_branches: 'Tüm Depolar',
    ...
    branchIdentical: 'İki depo aynı olamaz !!',
    ...
    branchestockChart: 'Wdepo Stok Tablosu',
    ...
    Selectbranch: 'Lütfen depo seçin',
    ...
    branchestockChart: 'Depo Stok Tablosu',
    ...
    Name: 'İsim',
    Code: 'Kod',
    Managementbranch: 'Depo yönetimi',
    ZipCode: 'Posta kodu',
    ...
    PleaseSelectbranch: 'Lütfen herhangi bir ürün seçmeden önce depoyu seçin',
    ...
    ReturnDashboard: 'kontrol paneline dön',
     ...
     Assigned_branches:'Atanmış depolar',
    ...
    Qty_purchased:'satın alınan miktar',
    Filter_by_branch:'Mağazaya göre filtrele',
    Enable_Print_Invoice:'Faturayı otomatik olarak yazdır',
    Show_branch:'ambarı göster',
