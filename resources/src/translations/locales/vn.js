...
export default {
    ...
    Enter_Name_branch: 'Nhập tên kho',
    Enter_Phone_branch: 'Nhập số điện thoại kho hàng',
    Enter_Country_branch: 'Nhập quốc gia kho hàng',
    Enter_City_branch: 'Nhập thành phố kho hàng',
    Enter_Email_branch: 'Nhập Email Kho hàng',
    Enter_ZipCode_branch: 'Nhập mã Zip kho hàng',
    ...
    branch_report: 'Báo cáo kho hàng',
    All_branches: 'Tất cả các kho hàng',
    ...
    branchIdentical: 'Hai kho không thể giống hệt nhau !!',
    ...
    branchestockChart: 'Biểu đồ kho hàng',
    ...
    Selectbranch: 'Vui lòng chọn kho',
    ...
    Frombranch: 'Từ kho hàng',
    Tobranch: 'Đến nhà kho',
    ...
    Delete: {
        ...
        branchDeleted: 'Kho này đã bị xóa.',
    ...
    PleaseSelectbranch: 'Vui lòng chọn kho trước khi chọn bất kỳ sản phẩm nào',
    ...
    ReturnDashboard: 'trở lại trang tổng quan',
     ...
     Assigned_branches:'Kho được giao',
    ...
    Qty_purchased:'số lượng đã mua',
    Filter_by_branch:'Lọc theo nhà kho',
