...
export default {
  ...
  methods: {
    ...
    search(){
      ...
      if (this.adjustment.branch_id != "" &&  this.adjustment.branch_id != null) {
    ...
    Get_Products_By_branch(id) {
      // Start the progress bar.
        ...
        NProgress.set(0.1);
      axios
        .get("get_Products_by_branch/" + id + "?stock=" + 0 + "&product_service=" + 0)
         .then(response => {
    ...
    GetElements() {
      ...
      axios
        ...
        .then(response => {
          ...
          this.Get_Products_By_branch(this.adjustment.branch_id);
