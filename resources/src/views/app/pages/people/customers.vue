<template>
  <div class="main-content">
      ...
      >
        ...
        <template slot="table-row" slot-scope="props">
          <span v-if="props.column.field == 'actions'">
            ...
            <span v-else-if="props.column.field == 'customeravatar'">
            <b-img
                thumbnail
                height="50"
                width="50"
                fluid
                :src="getAvatarUrl(props.row.customeravatar)"
                alt="User Avatar"
            ></b-img>
          </span>
    ...
    <validation-observer ref="Create_Customer">
      <b-modal ref="clientModal" @hidden="reset_Form" hide-footer size="lg" id="New_Customer" :title="editmode?$t('Edit'):$t('Add')">
        <b-form @submit.prevent="Submit_Customer">
          <b-row>
            ...
            <b-col md="6" sm="12">
              ...
              <!-- Customer Tracker ID -->
              <b-col md="6" sm="12">
                  <b-form-group :label="$t('Tracker_Id')">
                      <b-form-input
                          label="Tracker Id"
                          v-model="client.tracker_id"
                          :placeholder="$t('Tracker_Id')"
                      ></b-form-input>
                  </b-form-group>
              </b-col>
              <!-- Customer Tracker Model -->
              <b-col md="6" sm="12">
                  <b-form-group :label="$t('Tracker_Model')">
                      <b-form-input
                          label="Tracker Model"
                          v-model="client.tracker_model"
                          :placeholder="$t('Tracker_Model')"
                      ></b-form-input>
                  </b-form-group>
              </b-col>
            ...
            <b-col md="12" sm="12">
              ...
              <!-- Customer Address on Google -->
              <!-- Customer Adress -->
              <b-col md="12" sm="12">
                  <b-form-group :label="$t('Google_Address')">
                  <textarea
                      label="Google_Address"
                      class="form-control"
                      rows="4"
                      v-model="client.googleadresse"
                      :placeholder="$t('Google Address Link')"
                  ></textarea>
                  </b-form-group>
              </b-col>
...
<!--              Guarantors -->
              ...
              <!-- Name -->
              <b-col md="6" sm="12">
                  <b-form-group :label="$t('FullName Guarantor1')">
                      <b-form-input
                          label="FullName"
                          v-model="client.gurantorfullnameg1"
              ...
              <!--  Phone -->
              <b-col md="6" sm="12">
                  <b-form-group :label="$t('Phone Guarantor1')">
                      <b-form-input
                          label="PhoneG1"
                          v-model="client.gurantorphoneg1"
                          :placeholder="$t('Phone')"
                      ></b-form-input>
                  </b-form-group>
              </b-col>
              ...
              <b-col md="6" sm="12">
                  <b-form-group :label="$t('Google_Address Guarantor1')">
                      <b-form-input
                          label="Tax Number"
                          v-model="client.gurantorgoogle_address_g1"
              ...
              <!-- Name -->
              <b-col md="6" sm="12">
                  <b-form-group :label="$t('FullName Guarantor2')">
                      <b-form-input
                          label="FullName"
                          v-model="client.gurantorfullnameg2"
                          :placeholder="$t('Fullname')"
                      ></b-form-input>
                  </b-form-group>
              </b-col>
              ...
              <!--  Phone -->
              <b-col md="6" sm="12">
                  <b-form-group :label="$t('Phone Guarantor2')">
                      <b-form-input
                          label="PhoneG1"
                          v-model="client.gurantorphoneg2"
                          :placeholder="$t('Phone')"
                      ></b-form-input>
                  </b-form-group>
              </b-col>
              ...
              <b-col md="6" sm="12">
                  <b-form-group :label="$t('Google_Address Guarantor2')">
                      <b-form-input
                          label="Tax Number"
                          v-model="client.gurantorgoogle_address_g2"
                          :placeholder="$t('Google_Address')"
                      ></b-form-input>
                  </b-form-group>
              </b-col>
              ...
              <b-col md="6" sm="12" class="mb-3">
                  <validation-provider name="Avatar" ref="Avatar" >
                      <b-form-group slot-scope="{ validate, valid, errors }" :label="$t('Customer Image')">
                          <input
                              :state="errors[0] ? false : (valid ? true : null)"
                              :class="{'is-invalid': !!errors.length}"
                              @change="onCFileSelected('customeravatar', $event)"
                              label="Choose Avatar"
                              type="file"
                          >
        ...
        <b-col lg="12" md="12" sm="12" class="mt-3">
          <table class="table table-striped table-md">
            <tbody>
              ...
              <tr>
                  <!-- Customer Name -->
                  <td>{{$t('CustomerGuarantorName')}}</td>
                  <th>{{client.Guarantor1_name}}</th>
              </tr>
              <tr>
                  <!-- Customer Phone -->
                  <td>{{$t('Guarantor Phone')}}</td>
                  <th>{{client.Guarantor1_phone}}</th>
              </tr>
              <tr>
                  <!-- Customer Email -->
                  <td>{{$t('Guarantor address')}}</td>
                  <th>{{client.Guarantor1_house}}</th>
              </tr>
              <tr>
                  <tr>
                      <!-- Customer Name -->
                      <td>{{$t('Guarantor name')}}</td>
                      <th>{{client.Guarantor2_name}}</th>
                  </tr>
                  <tr>
                      <!-- Customer Phone -->
                      <td>{{$t('Guarantor Phone')}}</td>
                      <th>{{client.Guarantor2_phone}}</th>
                  </tr>
                  <tr>
                      <!-- Customer Email -->
                      <td>{{$t('Guarantor address')}}</td>
                      <th>{{client.Guarantor2_house}}</th>
                  </tr>
                  </tr>
              </tbody>
            </table>
          ...
          <b-col md="12" sm="12">
            <table class="table table-bordered table-sm mt-4">
              <tbody>
                ...
                <tr>
                    <td>{{$t('Tracker_Model')}}</td>
                </tr>
                <tr>
                    <td>{{$t('Google_Address')}}</td>
                </tr>
                <tr>
                    <td>{{$t('Guarantor 1 Name')}}</td>
                </tr>
                <tr>
                    <td>{{$t('Guarantor 1 Address')}}</td>
                </tr>
                <tr>
                    <td>{{$t('Guarantor 1 Phone')}}</td>
                </tr>
                <tr>
                    <td>{{$t('Guarantor 2 Name')}}</td>
                </tr>
                <tr>
                    <td>{{$t('Guarantor 2 Address')}}</td>
                </tr>
                <tr>
                    <td>{{$t('Guarantor 2 Phone')}}</td>
                </tr>
...
export default {
  ...
  data() {
    return {
      ...
      client: {
        ...
        gurantorphoneg1:"",
        gurantorphoneg2:"",
        gurantorgoogle_address_g1:"",
        gurantorgoogle_address_g2:"",
          googleadresse:"",
          tracker_model:"",
          tracker_id:"",
          customeravatar: null,
    ...
    columns() {
      return [
...

        {
          ...
          {
              label: this.$t("Tracker_Id"),
              field: "tracker_id",
              tdClass: "text-left",
              thClass: "text-left"
          },  {
              label: this.$t("Tracker_Model"),
              field: "tracker_model",
              tdClass: "text-left",
              thClass: "text-left"
          },  {
              label: this.$t("Google house link"),
              field: "google_map_address",
              tdClass: "text-left",
              thClass: "text-left"
          },
          {
              label: this.$t("Guarantor 1"),
  ...
  methods: {
      ...
      getAvatarUrl(avatar) {
          return `/images/avatar/${avatar || 'no_avatar.png'}`;
      },

      //------------------------------ Event Upload Avatar -------------------------------\\
      async   onCFileSelected(customeravatar, event) {
          this.client.customeravatar = event.target.files[0];
      },
      ...
      async onGFileSelected(e) {
          ...
          if (valid) {
              this.client.g1avatar = e.target.files[0];
          } else {
              this.client.g1avatar = "";
          }
      },
      //------------------------------ Event Upload Guarantor Avatar -------------------------------\\
      async onG2FileSelected(e) {
          ...
          if (valid) {
              this.client.g2avatar = e.target.files[0];
          } else {
              this.client.g2avatar = "";
          }
      },
...
//---------------------------------------- Create new Client -------------------------------\\
      Create_Client() {
          ...
          formData.append("name", self.client.name);
          formData.append("email", self.client.email);
          formData.append("phone", self.client.phone);
          formData.append("tax_number", self.client.tax_number);
          formData.append("country", self.client.country);
          formData.append("city", self.client.city);
          formData.append("adresse", self.client.adresse);
          formData.append("gurantorfullnameg1", self.client.gurantorfullnameg1);
          formData.append("gurantorphoneg1", self.client.gurantorphoneg1);
          formData.append("gurantorgoogle_address_g1", self.client.gurantorgoogle_address_g1);
          formData.append("gurantorfullnameg2", self.client.gurantorfullnameg2);
          formData.append("gurantorphoneg2", self.client.gurantorphoneg2);
          formData.append("gurantorgoogle_address_g2", self.client.gurantorgoogle_address_g2);
          formData.append("googleadresse", self.client.googleadresse);
          formData.append("tracker_model", self.client.tracker_model);
          formData.append("tracker_id", self.client.tracker_id);

          // Handle file uploads
          if (self.client.customeravatar) {
              formData.append("customeravatar", self.client.customeravatar);
          }
          if (self.client.g1avatar) {
              formData.append("g1avatar", self.client.g1avatar);
          }
          if (self.client.g2avatar) {
              formData.append("g2avatar", self.client.g2avatar);
          }
          ...
          axios
              ...
              .then(response => {
                  ...
                  Fire.$emit("Event_Client");
                  this.makeToast("success", this.$t("Create.TitleCustomer"), this.$t("Success"));
                  self.reset_Form();  // Reset form after success
                  self.closeForm();   // Close form/modal after success (you need to implement closeForm method)
              })
              .catch(error => {
                  self.SubmitProcessing = false;
                  this.makeToast("danger", this.$t("InvalidData"), this.$t("Failed"));
      ...
      //     self.SubmitProcessing = true;
      //
      //     self.data.append("name", self.client.name);
      //     self.data.append("email", self.client.email);
      //     self.data.append("phone", self.client.phone);
      //     self.data.append("tax_number", self.client.tax_number);
      //     self.data.append("country", self.client.country);
      //     self.data.append("city", self.client.city);
      //     self.data.append("adresse", self.client.adresse);
      //     self.data.append("gurantorfullnameg1", self.client.gurantorfullnameg1);
      //     self.data.append("gurantorphoneg1", self.client.gurantorphoneg1);
      //     self.data.append("gurantorgoogle_address_g1", self.client.gurantorgoogle_address_g1);
      //     self.data.append("gurantorfullnameg2", self.client.gurantorfullnameg2);
      //     self.data.append("gurantorphoneg2", self.client.gurantorphoneg2);
      //     self.data.append("gurantorgoogle_address_g2", self.client.gurantorgoogle_address_g2);
      //     self.data.append("googleadresse", self.client.googleadresse);
      //     self.data.append("tracker_model", self.client.tracker_model);
      //     self.data.append("tracker_id", self.client.tracker_id);
      //     self.data.append("customeravatar", self.client.customeravatar);
      //     self.data.append("g1avatar", self.client.g1avatar);
      //     self.data.append("g2avatar", self.client.g2avatar);
      //
      //     axios
