  ...
  methods: {
   ...
   // Search Products
    search(){
      ...
      if (this.quote.branch_id != "" &&  this.quote.branch_id != null) {
    ...
    Get_Products_By_branch(id) {
      // Start the progress bar.
        ...
        NProgress.set(0.1);
      axios
        .get("get_Products_by_branch/" + id + "?stock=" + 1 + "&product_service=" + 1)
         .then(response => {
    ...
    GetElements() {
      ...
      axios
        ...
        .then(response => {
          ...
          this.Get_Products_By_branch(this.quote.branch_id);
          this.Calcul_Total();
