<template>
  <div class="main-content">
    <breadcumb :page="$t('branch_report')" :folder="$t('Reports')"/>
...
export default {
  ...
  methods: {
    ...
    Get_Reports() {
      axios
        .get("report/branch_report?branch_id=" + this.Filter_branch)
        .then(response => {
    ...
    Get_Returns_Sale(page) {
      axios
        .get(
          "report/returns_sale_branch?page=" +
            page +
            "&limit=" +
    ...
    Get_Returns_Purchase(page) {
      axios
        .get(
          "report/returns_purchase_branch?page=" +
            page +
            "&limit=" +
