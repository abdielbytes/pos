    ...
    <b-sidebar id="sidebar-right" :title="$t('Filter')" bg-variant="white" right shadow>
      <div class="px-3 py-2">
        <b-row>
          ...
          <!-- From branch  -->
          <b-col md="12">
            <b-form-group :label="$t('Frombranch')">
              <v-select
        ...
        <b-col lg="5" md="12" sm="12" class="mt-3">
          <table class="table table-hover table-bordered table-sm">
            <tbody>
              ...
              <tr>
                <td>{{$t('Frombranch')}}</td>
                <th>{{transfer.from_branch}}</th>
              </tr>
              <!-- To branch -->
              <tr>
                <td>{{$t('Tobranch')}}</td>
                <th>{{transfer.to_branch}}</th>
              </tr>
              <!-- Grand Total -->
              <tr>
                <td>{{$t('Total')}}</td>
...
export default {
  ...
  computed: {
    ...
    columns() {
      return [
        ...
        {
          label: this.$t("Frombranch"),
          field: "from_branch",
          tdClass: "text-left",
          thClass: "text-left"
        },
        {
          label: this.$t("Tobranch"),
          field: "to_branch",
          tdClass: "text-left",
          thClass: "text-left"
        },
  ...
  methods: {
    ...
    onSortChange(params) {
      let field = "";
      if (params[0].field == "from_branch") {
        field = "from_branch_id";
      } else if (params[0].field == "to_branch") {
        field = "to_branch_id";
      } else {
    ...
    Transfer_PDF() {
      ...
      let columns = [
        ...
        { title: "From branch", dataKey: "from_branch" },
        { title: "To branch", dataKey: "to_branch" },
