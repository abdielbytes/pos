...
use App\Http\Controllers\hrm\EmployeeSessionController;
...
Route::middleware(['auth:api', 'Is_Active'])->group(function () {
    ...
    // Route::post("installments", [InstallmentsController::class, 'create']);
    ...
    Route::put('/installments/{id}', [InstallmentsController::class, 'update'])->middleware('ceo');

    //-------------------------- Clear Cache ---------------------------

    Route::get("clear_cache", "SettingsController@Clear_Cache");

    Route::post('/transfer', [WalletController::class, 'transfer'])->middleware('auth:api');
    ...
    Route::get("report/branch_report", "ReportController@branch_Report");
    Route::get("report/sales_branch", "ReportController@Sales_branch");
    Route::get("report/quotations_branch", "ReportController@Quotations_branch");
    Route::get("report/returns_sale_branch", "ReportController@Returns_Sale_branch");
    Route::get("report/returns_purchase_branch", "ReportController@Returns_Purchase_branch");
    Route::get("report/expenses_branch", "ReportController@Expenses_branch");
    ...
    Route::get('/profile', [ProfileViewController::class, 'show']);
    ...
    Route::get('get_Products_by_branch/{id}', 'ProductsController@Products_by_branch');
    ...
    Route::post('branches/delete/by_selection', 'branchController@delete_by_selection');
    ...
    //------------------------------- Payments  Sales --------------------------\\
    //------------------------------------------------------------------\\
    Route::post('/penalty_sale', [PenaltyController::class, 'store']);
//    Route::resource('penalty_sale', 'PenaltyController');
...
//    Payment Penalties \\
    ...
    // Route::resource('penalty_payment', PenaltyPaymentsController::class);
